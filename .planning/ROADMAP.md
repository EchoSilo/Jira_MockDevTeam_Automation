...
Plans:
- [x] 04-01-PLAN.md - Chaos models and configuration (RandomEvent, ChaosConfig, settings.yaml)
- [x] 04-02-PLAN.md - RandomEventGenerator with probability rolling (TDD)
- [x] 04-03-PLAN.md - Event catalog with archetype-specific weights
- [x] 04-04-PLAN.md - ScenarioAdapter for event-driven scenario modification
- [x] 04-05-PLAN.md - ConfidenceTracker with accept reality mode (TDD)
- [x] 04-06-PLAN.md - PathfindingAdapter for RECALCULATE strategy handling
- [x] 04-07-PLAN.md - Integration: Wire chaos components into /trigger endpoint
