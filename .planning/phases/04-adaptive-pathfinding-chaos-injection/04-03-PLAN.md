...
must_haves:
  ...
  key_links:
    ...
    - from: "src/chaos/event_catalog.py"
      ...
      via: "ScenarioArchetype enum import"
      pattern: "from src\\.scenarios\\.sprint_scenario import ScenarioArchetype"
---
...
@src/chaos/models.py
@src/scenarios/sprint_scenario.py  # Provides ScenarioArchetype enum (from Phase 3)
</context>
...
Update src/chaos/__init__.py to export EventCatalog.
  ...
  <verify>`python -c "from src.chaos import EventCatalog; ec = EventCatalog(); print(list(ec._templates.keys()))"` shows templates loaded</verify>
